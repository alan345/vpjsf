export const SITE = {
  ...
  // Domaine canonique. Surcharge possible via NEXT_PUBLIC_SITE_URL
  // (ex. http://localhost:3000 en local). À défaut, on utilise la prod.
  url:
    process.env.NEXT_PUBLIC_SITE_URL?.replace(/\/$/, "") ||
    "https://www.voilapourquoijesuisfauche.fr",
  author: "Alan",
  locale: "fr_FR",
